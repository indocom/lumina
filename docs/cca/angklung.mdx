...
<img alt="NUS Angklung Ensemble logo" src={useBaseUrl('/img/cca/angklung.png')} style={{maxWidth: '400px', maxHeight: '300px'}}/>
...
<img alt="NUS Angklung ensemble" src={useBaseUrl('/img/cca/angklung/exco.png')} style={{maxWidth: '400px', maxHeight: '300px'}}/>
